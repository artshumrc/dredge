...
//   __DREDGE_SORT_FIELD__  the DredgeSortField union of sortable columns
...
// __DREDGE_SORT_FIELD_START__
export type DredgeSortField = string;
// __DREDGE_SORT_FIELD_END__
